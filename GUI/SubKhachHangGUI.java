...
public class SubKhachHangGUI {
    ...
    private JTextField tFieldSearch, tf, tfName;
    ...
    public SubKhachHangGUI(JTextField tf, JTextField tfName){
        this.tf = tf;
        this.tfName = tfName;
    ...
    public void tableMountClick(){
        ...
        tenNV = (String) table.getValueAt(rowSelect, 1);
    }
}
